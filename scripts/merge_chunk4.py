...
files_to_merge = [
    "data/gen_chunk4_1.json",
    "data/gen_chunk4_2.json",
    "data/gen_chunk4_3.json",
    "data/gen_chunk4_4.json",
    "data/gen_chunk4_5.json"
]
...
with open("data/dataset_chunk_4_fully_assembled.json", "w") as f:
    json.dump(final_list, f, indent=2)

print(f"Successfully assembled {target_count} unique RTL samples.")
print("Saved to data/dataset_chunk_4_fully_assembled.json")
