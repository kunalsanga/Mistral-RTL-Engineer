...
files_to_merge = [
    "data/gen_chunk3_1.json",
    "data/gen_chunk3_2.json",
    "data/gen_chunk3_3.json",
    "data/gen_chunk3_4.json",
    "data/gen_chunk3_5.json"
]
...
# Deduplicate based on instruction to ensure unique RTL examples
unique_samples = {}
...
with open("data/dataset_chunk_3_fully_assembled.json", "w") as f:
    json.dump(final_list, f, indent=2)

print(f"Successfully assembled {target_count} unique RTL samples.")
print("Saved to data/dataset_chunk_3_fully_assembled.json")
